package Audio::TagLib::ID3v2::FrameListMap::Iterator;
...
L<FrameListMap|Audio::TagLib::ID3v2::FrameListMap>.
...
=item I<new(L<Iterator|Audio::TagLib::ID3v2::FrameListMap::Iterator> $it)>
...
=item I<L<FrameList|Audio::TagLib::ID3v2::FrameList> data()>

Returns the L<FrameList|Audio::TagLib::ID3v2::FrameList> pointed by current iterator.

overloaded by operator q(${})

=item I<L<Iterator|Audio::TagLib::ID3v2::FrameListMap::Iterator> next()>

Moves to next item.

overloaded by operator q(++)

=item I<L<Iterator|Audio::TagLib::ID3v2::FrameListMap::Iterator> last()>

Moves to last item.

overloaded by operator q(--)

=item I<void copy(L<Iterator|Audio::TagLib::ID3v2::FrameListMap::Iterator> $it)>
